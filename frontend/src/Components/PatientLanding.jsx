      ...
      <div className="body">
        <div className="title">
          <div className="text">
            <span id="greet">
              {" "}
              Welcome, <span id="name">{location.state.id}</span>{" "}
            </span>
            <span id="small-text">
          ...
          <div className="icons">
            <span className="sq">
              <img id="search" src={require("../static/images/search.png")} />
            </span>
            <span className="sq">
              <img id="bell" src={require("../static/images/bell.png")} />
            </span>
            <span className="sq">
              <img
                id="person"
          ...
          <div className="sqboxButton">
            <a href="http://localhost:3000/Questionare1">
              <button>
                <img
                  id="clip"
                  src={require("../static/images/clipboard.png")}
                />
                Take A Quick Diagnostic Quiz
              </button>
            </a>
          </div>
        </div>
